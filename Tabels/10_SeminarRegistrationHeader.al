table 123456710 "CSD Seminar Reg. Header"
{
    ...
    fields
    {
        ...
        field(6; "Instructor Name"; Text[50])
        {
            ...
            CalcFormula = Lookup (Resource.Name where ("No." = Field ("Room Resource No."),
                                                      Type = const (Person)));
            Editable = false;
    ...
    begin
        ...
        SeminarSetup.GET; NoSeriesMgt.SetDefaultSeries("Posting No. Series", SeminarSetup."Posted Seminar Reg. Nos.");
    end;
